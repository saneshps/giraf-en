...
<body>
      ...
      <div class="container">
        <div class="row box-commn">
          ...
          <div class="col-xl-8 col-lg-8 col-md-12 services-text-scnd">
            <p> We may not be the best singers or dancers, but we are in no way far from the best digital marketing professionals.
              In the game of competitiveness, yes- we play to win
            </p>
          </div>
          <!--// col-md-8 -->
  ...
  <section class="services-list-area serv-detail">
    <div class="container">
      ...
      <h2> 360 degree Digital Marketing </h2>
      <div class="row">
      ...
      <div class="container">
        <div class="row box-commn">
          ...
          <div class="col-xl-8 col-lg-8 col-md-12 benifits-scnd">
            <p> We are young, we are creative, we are ambitious. We are in this for a
              long term and we like to see you succeed,
